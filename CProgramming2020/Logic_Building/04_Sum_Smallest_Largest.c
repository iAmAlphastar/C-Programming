...
//Date : 03 Nov 2020
//Program : Accept 4 number from user and find the sum of smallest & largest.
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
    //Local variables.
    int iValue1 , iValue2 , iValue3 , iValue4 , iLargest = 0, iSmallest = 0 , iSum = 0;
    ...
    iSum = iLargest + iSmallest;
    
    printf("largest %d\nsmallest %d\nThe sum of  %d + %d = %d\n\n",iLargest,iSmallest,iLargest,iSmallest,iSum);
